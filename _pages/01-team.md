...
<div id = "{{person.name | replace: ' ', '-'}}" class="row" style="padding-top: 60px; margin-top: -60px;">
        ...
        {% if person.image %}
          <img style="float: right; width: 32%; padding-left: 20px;" src="{{ person.image | prepend: '/assets/img/' | prepend: site.baseurl | prepend: site.url }}" alt="photo of {{person.name}}">
        ...
        {% elsif person.imageurl %}
          <img style="float: right; width: 32%; padding-left: 20px;" src="{{ person.imageurl }}" alt="photo of {{person.name}}">
        {% endif %}
    <div>
